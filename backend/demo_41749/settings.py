"""
Django settings for demo_41749 project.
...
WSGI_APPLICATION = 'demo_41749.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "demo_41749 API",
    "DESCRIPTION": "API documentation for demo_41749 App",
    "VERSION": "v1",
}
